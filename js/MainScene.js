  ...
  render: function() {
    return (
      ...
      <ViroParticleEmitter
        ...
        image={{
          source:require("./img/particle_snow.png"),
          height:0.01,
          width:0.01,
          bloomThreshold:1.0
        }}
     ...
     />
      ...
      <Viro3DObject
        source={require('./img/icecreamman_anim_a.vrx')}
        resources={[require('./img/icecreamman_diffuse.png'),
                    require('./img/icecreamman_normal.png'),
                    require('./img/icecreamman_specular.png')]}
        position={[0, 0, 0]}
        scale={[.5, .5, .5]}
        type="VRX"
